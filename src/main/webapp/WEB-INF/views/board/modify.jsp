...
<body>
    ...
    <div class="view-box">
        ...
        <form action="/board/modify" method="POST">
            ...
            <ul>
                <li><label for="writer"># 작성자:</label><input type="text" name="writer" placeholder="${article.writer}"></li>
                <li><label for="title"># 글제목:</label><input type="text" name="title" value="${article.title}"></li>
